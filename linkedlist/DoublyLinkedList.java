public class DoublyLinkedList<E> 
{
   ...
   */
  public E first() {
    return isEmpty() ? null : header.getElement();
  }
   ...
   */
  public E last() {
    return isEmpty() ? null : trailer.getElement();
  }
  ...
  public void addFirst(E e) {
      ...
      if(header == null) {
        ...
        Node temp = new Node(e, null, header);
        header.setPrev(temp);
        header = temp;
      }
      size++;
  ...
  public E removeLast() {
    ...
    E returnvar = trailer.getElement();
